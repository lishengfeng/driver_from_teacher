...
struct eth_priv {
	void __iomem *virt;//0x19000000(index) 0x19000004(data)
	void __iomem *bw_v;//16
	spinlock_t lock;
};

#define S3C_PA_BW		0x70000000
#define S3C_SZ_BW		SZ_4K
#define BW16			(1 << 4)

#define S3C_PA_IO		0x19000000
#define S3C_PA_DATA		0x19000004
#define S3C_SZ_DM9000		SZ_4K
